...
window.I18N = {
    namu: {
        ...
        /* ── challenge a friend ── */
        btnChallenge:          '친구에게 도전 📨',
        challengeCopied:       '도전 링크 복사! 친구에게 공유하세요 🔗',
        challengeBannerTitle:  '🔥 친구의 도전장!',
        ...
        btnHint:               '힌트',
        statHints:             '힌트 사용',
        hint1:                 (n) => `목표 페이지는 ${n}글자입니다`,
        hint2:                 (c) => `목표의 첫 글자는 '${c}'입니다`,
        hint3:                 (s) => `목표 이름 힌트: ${s}`,
        hintNoMore:            '힌트를 모두 사용했습니다 (최대 3회)',
        /* ── daily share ── */
    ...
    en: {
        ...
        btnChallenge:          'Challenge a Friend 📨',
        challengeCopied:       'Challenge link copied! Share it with a friend 🔗',
        challengeBannerTitle:  '🔥 Friend Challenge!',
        ...
        hint1:                 (n) => `Goal has ${n} characters`,
        hint2:                 (c) => `First letter: '${c}'`,
        hint3:                 (s) => `Goal name: ${s}`,
        hintNoMore:            'No more hints (max 3)',
        dailyShareText:        (gs, day, time) =>
            `📅 Linky Run — Day ${day}\n${gs.start} → ${gs.goal}\n⏱ ${time}  🔗 ${gs.hops} hops\nPath: ${(gs.path||[]).join(' → ')}\n🌐 ${window.location.origin}`,
    },
    ...
    de: {
        ...
        btnChallenge:          'Freund herausfordern 📨',
        challengeCopied:       'Link kopiert! Teile ihn mit einem Freund 🔗',
        challengeBannerTitle:  '🔥 Herausforderung!',
        ...
        btnHint:               'Hinweis',
        statHints:             'Hinweise',
        hint1:                 (n) => `Das Ziel hat ${n} Zeichen`,
        hint2:                 (c) => `Erster Buchstabe: '${c}'`,
        hint3:                 (s) => `Zielname: ${s}`,
        hintNoMore:            'Keine Hinweise mehr (max. 3)',
        dailyShareText:        (gs, day, time) =>
            `📅 Linky Run — Tag ${day}\n${gs.start} → ${gs.goal}\n⏱ ${time}  🔗 ${gs.hops} Klicks\nPfad: ${(gs.path||[]).join(' → ')}\n🌐 ${window.location.origin}`,
    },
    ...
    fr: {
        ...
        btnChallenge:          'Défier un ami 📨',
        challengeCopied:       'Lien copié ! Partage-le avec un ami 🔗',
        challengeBannerTitle:  '🔥 Défi d\'un ami !',
        ...
        btnHint:               'Indice',
        statHints:             'Indices utilisés',
        hint1:                 (n) => `L\'objectif a ${n} caractères`,
        hint2:                 (c) => `Première lettre : '${c}'`,
        hint3:                 (s) => `Nom de l\'objectif : ${s}`,
        hintNoMore:            'Plus d\'indices (max 3)',
        dailyShareText:        (gs, day, time) =>
            `📅 Linky Run — Jour ${day}\n${gs.start} → ${gs.goal}\n⏱ ${time}  🔗 ${gs.hops} clics\nChemin : ${(gs.path||[]).join(' → ')}\n🌐 ${window.location.origin}`,
    },
    ...
    ja: {
        ...
        btnChallenge:          '友達に挑戦 📨',
        challengeCopied:       '挑戦リンクをコピーしました！友達にシェアしよう 🔗',
        challengeBannerTitle:  '🔥 友達からの挑戦状！',
